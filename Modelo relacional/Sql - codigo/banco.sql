...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-10-2016 a las 18:35:04
...
INSERT INTO `acceso` (`id`, `persona`, `password`) VALUES
(1, 1096038704, '123');
...
INSERT INTO `banco` (`id`, `nombre`, `nit`, `vision`, `mision`, `sede`) VALUES
(1, 'Banco Del Emprendimiento', '1096038704-1', 'Esta es la visión del banco', 'Esta es la misión del banco', 1);
...
CREATE TABLE `cargos` (
  `id` int(11) NOT NULL,
  `descripcion` varchar(50) NOT NULL DEFAULT 'NULL',
  `salario` double NOT NULL,
  `horas_semanales` double DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `consignaciones` (
  ...
  `cedula_consignatario` varchar(20) NOT NULL DEFAULT 'NULL'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `cuentas` (
  ...
  `cliente` int(11) NOT NULL,
  `contraseña` varchar(50) NOT NULL DEFAULT 'NULL',
...
CREATE TABLE `movimientos` (
  `id` int(11) NOT NULL,
  `lugar` varchar(200) NOT NULL DEFAULT 'NULL',
...
CREATE TABLE `personas` (
  ...
  `nombre` varchar(50) NOT NULL DEFAULT 'NULL',
  `apellidos` varchar(50) NOT NULL DEFAULT 'NULL',
...
INSERT INTO `personas` (`cedula`, `nombre`, `apellidos`, `fecha_nacimiento`, `fecha_ingreso`, `ciudad`, `telefono`, `email`, `direccion`) VALUES
(1096038704, 'Yan Carlo', 'Marin Osorio', '1996-01-21', '2016-10-07', 1001, '3107172522', 'yancarlosmarinosorio@gmail.com', 'Los alpes carrera 4° #15-12');
...
CREATE TABLE `prestamos` (
  ...
  `fecha` date NOT NULL,
  `monto` double NOT NULL,
  `estado` int(11) DEFAULT '0' COMMENT 'si el estado es 0, entonces significa que no ha sido revisada la solicitud, si es uno entonces fu e aceptada, si es 2 la solicitud fue rechazada.',
  `cliente` int(11) NOT NULL,
  `asesor` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `sucursales` (
  `id` int(11) NOT NULL,
  `nombre` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'NULL',
...
INSERT INTO `sucursales` (`id`, `nombre`, `gerente`, `ciudad`, `direccion`) VALUES
(1, 'Príncipal', 1096038704, 882, 'carrera 5° #8-12');
...
--
-- Estructura de tabla para la tabla `tipos_cuenta_montos`
--

CREATE TABLE `tipos_cuenta_montos` (
  `id` int(11) NOT NULL,
...
ALTER TABLE `sucursales`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ciudad` (`ciudad`),
  ADD KEY `sucursales_gerente_1` (`gerente`);
...
--
-- Indices de la tabla `tipos_cuenta_montos`
--
ALTER TABLE `tipos_cuenta_montos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `costo` (`costo`),
  ADD KEY `tipo_cuenta` (`tipo_cuenta`);
...
--
ALTER TABLE `personas`
  MODIFY `cedula` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1096038705;
--
...
ALTER TABLE `tipos_cuenta`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `tipos_cuenta_montos`
--
ALTER TABLE `tipos_cuenta_montos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `acceso`
  ADD CONSTRAINT `acceso_ibfk_1` FOREIGN KEY (`persona`) REFERENCES `personas` (`cedula`);

--
-- Filtros para la tabla `banco`
--
ALTER TABLE `banco`
  ADD CONSTRAINT `banco_ibfk_1` FOREIGN KEY (`sede`) REFERENCES `sucursales` (`id`);
...
--
-- Filtros para la tabla `clientes_sucursales`
--
ALTER TABLE `clientes_sucursales`
  ADD CONSTRAINT `clientes_sucursales_ibfk_1` FOREIGN KEY (`cliente`) REFERENCES `personas` (`cedula`),
  ADD CONSTRAINT `clientes_sucursales_ibfk_2` FOREIGN KEY (`sucursal`) REFERENCES `sucursales` (`id`);

--
-- Filtros para la tabla `consignaciones`
--
ALTER TABLE `consignaciones`
  ADD CONSTRAINT `consignaciones_ibfk_1` FOREIGN KEY (`movimiento`) REFERENCES `movimientos` (`id`);

--
-- Filtros para la tabla `cuentas`
--
ALTER TABLE `cuentas`
  ADD CONSTRAINT `cuentas_ibfk_1` FOREIGN KEY (`tipo_cuenta`) REFERENCES `tipos_cuenta` (`id`),
  ADD CONSTRAINT `cuentas_ibfk_2` FOREIGN KEY (`asesor`) REFERENCES `personas` (`cedula`),
  ADD CONSTRAINT `cuentas_ibfk_3` FOREIGN KEY (`cliente`) REFERENCES `personas` (`cedula`);
...
--
ALTER TABLE `empleados`
  ADD CONSTRAINT `empleados_ibfk_1` FOREIGN KEY (`persona`) REFERENCES `personas` (`cedula`),
  ADD CONSTRAINT `empleados_ibfk_2` FOREIGN KEY (`sucursal`) REFERENCES `sucursales` (`id`),
  ADD CONSTRAINT `empleados_ibfk_3` FOREIGN KEY (`cargo`) REFERENCES `cargos` (`id`);

--
-- Filtros para la tabla `movimientos`
--
ALTER TABLE `movimientos`
  ADD CONSTRAINT `movimientos_ibfk_1` FOREIGN KEY (`tipo_movimiento`) REFERENCES `tipos_movimiento` (`id`),
  ADD CONSTRAINT `movimientos_ibfk_2` FOREIGN KEY (`cuenta`) REFERENCES `cuentas` (`numero_cuenta`);

--
-- Filtros para la tabla `personas`
--
ALTER TABLE `personas`
  ADD CONSTRAINT `personas_ibfk_1` FOREIGN KEY (`ciudad`) REFERENCES `ciudades` (`id`);

--
-- Filtros para la tabla `prestamos`
--
ALTER TABLE `prestamos`
  ADD CONSTRAINT `prestamos_ibfk_1` FOREIGN KEY (`cliente`) REFERENCES `personas` (`cedula`),
  ADD CONSTRAINT `prestamos_ibfk_2` FOREIGN KEY (`asesor`) REFERENCES `personas` (`cedula`);

--
-- Filtros para la tabla `socios`
--
ALTER TABLE `socios`
  ADD CONSTRAINT `socios_ibfk_1` FOREIGN KEY (`persona`) REFERENCES `personas` (`cedula`);

--
-- Filtros para la tabla `sucursales`
--
ALTER TABLE `sucursales`
  ADD CONSTRAINT `sucursales_gerente_1` FOREIGN KEY (`gerente`) REFERENCES `personas` (`cedula`),
  ADD CONSTRAINT `sucursales_ibfk_1` FOREIGN KEY (`ciudad`) REFERENCES `ciudades` (`id`);

--
-- Filtros para la tabla `tipos_cuenta_montos`
--
ALTER TABLE `tipos_cuenta_montos`
  ADD CONSTRAINT `tipos_cuenta_montos_ibfk_1` FOREIGN KEY (`costo`) REFERENCES `costos` (`id`),
  ADD CONSTRAINT `tipos_cuenta_montos_ibfk_2` FOREIGN KEY (`tipo_cuenta`) REFERENCES `tipos_cuenta` (`id`);

--
-- Filtros para la tabla `transferencias`
--
ALTER TABLE `transferencias`
  ADD CONSTRAINT `transferencias_ibfk_1` FOREIGN KEY (`movimiento`) REFERENCES `movimientos` (`id`),
  ADD CONSTRAINT `transferencias_ibfk_2` FOREIGN KEY (`cuenta_destino`) REFERENCES `cuentas` (`numero_cuenta`);

--
-- Filtros para la tabla `webmaster`
--
ALTER TABLE `webmaster`
  ADD CONSTRAINT `webmaster_fk` FOREIGN KEY (`admin`) REFERENCES `personas` (`cedula`);
